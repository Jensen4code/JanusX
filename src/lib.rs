...
use garfield::{
    ...
    garfield_all_pair_scan_bin_xor_py, garfield_dosage_canonical_owner_plan_py,
    ...
    garfield_dosage_lm_screen_scan_canonical_owner_py, garfield_dosage_lm_screen_scan_py,
    garfield_dosage_lm_screen_scan_selected_grouped_py, garfield_dosage_lm_screen_scan_selected_py,
    garfield_dosage_lowrank_choose_rank_py, garfield_dosage_lowrank_grm_screen_scan_py,
    garfield_dosage_pair_fit_py, garfield_dosage_pair_scan_py, garfield_eval_rule_bin_py,
    garfield_logic_pair_cell_summary_py, garfield_logic_residual_screen_bin_py,
    ...
    score_cont_mean_diff_py, GarfieldDosageCanonicalTopK, GarfieldDosageGrmContext,
    GarfieldDosageLowrankScreenContext, GarfieldPackedBedDosageReader,
};
use gblup::{
...
fn janusx(_py: Python, m: &Bound<PyModule>) -> PyResult<()> {
    ...
    m.add_class::<GarfieldDosageCanonicalTopK>()?;
    m.add_class::<GarfieldDosageGrmContext>()?;
    m.add_class::<GarfieldDosageLowrankScreenContext>()?;
    ...
    m.add_function(wrap_pyfunction!(
        garfield_all_pair_scan_bin_with_cells_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(garfield_all_pair_scan_bin_xor_py, m)?)?;
    m.add_function(wrap_pyfunction!(garfield_logic_pair_cell_summary_py, m)?)?;
    m.add_function(wrap_pyfunction!(garfield_logic_residual_screen_bin_py, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(garfield_dosage_grm_pair_fit_py, m)?)?;
    m.add_function(wrap_pyfunction!(garfield_dosage_grm_pair_scan_py, m)?)?;
    m.add_function(wrap_pyfunction!(garfield_dosage_grm_pair_scan_batch_py, m)?)?;
    m.add_function(wrap_pyfunction!(garfield_dosage_grm_pair_scan_reml_py, m)?)?;
    m.add_function(wrap_pyfunction!(
        garfield_dosage_canonical_owner_plan_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        garfield_dosage_lm_screen_scan_canonical_owner_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(garfield_dosage_lm_screen_scan_py, m)?)?;
    m.add_function(wrap_pyfunction!(
        garfield_dosage_lm_screen_scan_selected_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        garfield_dosage_lm_screen_scan_selected_grouped_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        garfield_dosage_lowrank_grm_screen_scan_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(garfield_dosage_lowrank_choose_rank_py, m)?)?;
