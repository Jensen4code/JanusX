...
use garfield::{
    ...
    garfield_dosage_grm_pair_scan_py, garfield_dosage_pair_fit_py, garfield_dosage_pair_scan_py,
    garfield_eval_rule_bin_py, garfield_logic_search_bed_py, garfield_pair_triple_refine_bin_py,
